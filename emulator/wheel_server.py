   ...
   """
    ...
    while server is True:
        ...
        if client_choice == "1":
            ...
            choice = int(choice)
            t = cw.thread_with_trace(
                target=wheel.start_streaming, args=(choice,))
            t.start()
            print("")
            ...
            choice = client.recv(255).decode("utf-8")
            choice = int(choice)
            t = cw.thread_with_trace(target=wheel.start_recording,
                                     args=(choice,))
            t.start()
            print("")
...
while True:
    ...
    threads_clients.append(threading.Thread(
        None, instanceServeur, None, (client, infosClient, data_wheel), {}))
